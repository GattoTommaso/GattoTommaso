function creaPdf(){
    ...
    doc.text(20,30,'Questo \u00E8 un file PDF');

    doc.addPage();
    doc.text(20,20,'Prima Pagina:');
    doc.text(20,30,'Il nome: ' + nome);
    doc.text(20,40,'Il cognome: ' + cognome);
    doc.text(20,50,'Il numero: ' + numero);
    doc.text(20,60,"L'email: " + email);
